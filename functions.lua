...
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/blob/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████ @xb_0b      |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/blob/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/blob/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/blob/master/inc/functions.lua','./inc/functions.lua')
