...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/FAWAZ5265/FAWAZ5265.github.io/main/GetVersion.txt') or "0"
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/FAWAZ5265/abaza/main/plugins/"..FileName)
if res == 200 then
